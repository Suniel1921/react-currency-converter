...
const InputBox = ({ label, className = '', amount, onAmountChanage, onCurrencyChange, currencyOption = [], selectCurrency = 'usd', amountDisable = false, currencyDisable = false }) => {
      ...
      <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
        <div className='w-1/2'>
          ...
          <input id={amountInputId} className='outline-none w-full bg-transparent py-1.5'
            ...
            value={amount}
            onChange={(e)=> onAmountChanage && onAmountChanage(Number(e.target.value))}
          />
        </div>
